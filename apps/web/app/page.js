  ...
  return (
    <div className="gate">
      <section className="gate-copy">
        ...
        <p>
          Compose a banking, insurance, or telecommunications study, look at the path event by event, leave a note on the step that feels wrong, and start the next iteration from that note.
        </p>
      </section>
